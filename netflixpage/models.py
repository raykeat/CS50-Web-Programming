...
class Genres(models.Model):
    genreid = models.IntegerField(max_length=100,default=0)
    genre = models.CharField(max_length=100)


class Movies(models.Model):
    movieid = models.IntegerField(max_length=100,default=0)
...
class User(AbstractUser):
    ...
    liked_movies = models.ManyToManyField(Movies,related_name="likeduser")
    watchlist_movies = models.ManyToManyField(Movies,related_name="watchlistuser")
